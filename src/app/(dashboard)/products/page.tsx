...
const products = [
  {
    ...
    category: "Diagnostic",
    description:
      "Compact ECG machine with high resolution display and accurate readings.",
    price: 45000,
    oldPrice: 60000,
    rating: 4.6,
    reviews: 128,
  ...
  },
  {
    ...
    category: "Monitoring",
    description:
      "Advanced patient monitor for real-time vital signs monitoring.",
    price: 85000,
    oldPrice: 105000,
    rating: 4.7,
    reviews: 156,
  ...
  },
  {
    ...
    category: "Monitoring",
    description:
      "Accurate SpO2 and pulse rate monitoring in a compact design.",
    price: 2499,
    oldPrice: 3200,
    rating: 4.5,
    reviews: 98,
  ...
  },
  {
    ...
    description:
      "Efficient nebulizer for effective respiratory therapy.",
    price: 1999,
    oldPrice: 2800,
    rating: 4.4,
    reviews: 87,
  ...
  },
  {
    ...
    description:
      "Reliable infusion pump for precise fluid delivery.",
    price: 32000,
    oldPrice: 40000,
    rating: 4.6,
    reviews: 73,
    discount: "20% OFF",
    image:
      "https://images.unsplash.com/photo-1580281657527-47d1d8f8dbe3?w=800",
  },
  {
    id: 6,
    name: "Defibrillator",
    ...
    description:
      "Advanced defibrillator for emergency cardiac care.",
    price: 125000,
    oldPrice: 160000,
    rating: 4.8,
    reviews: 112,
  ...
  },
  {
    ...
    description:
      "High performance ventilator for critical care and ICU.",
    price: 250000,
    oldPrice: 320000,
    rating: 4.7,
    reviews: 63,
  ...
  },
  {
    ...
    category: "Mobility",
    description:
      "Durable and comfortable wheelchair for mobility support.",
    price: 8499,
    oldPrice: 10999,
    rating: 4.3,
    reviews: 54,
    ...
    <div className="min-h-screen bg-slate-50 px-6 py-10">
      ...
      <div className="max-w-7xl mx-auto mb-10">
        ...
        <p className="text-slate-500 mt-3 text-lg">
          Browse premium healthcare equipment
        </p>
